        ...
        <div className="bg-white shadow rounded-lg md:mt-0 w-full sm:max-w-screen-sm xl:p-0">
          <div className="p-6 sm:p-8 lg:p-16 space-y-8">
            ...
            <form className="mt-8 space-y-6" onSubmit={handleSubmit(onSubmit)}>
              ...
              <div className="flex items-start">
                <div className="flex items-center h-5">
                  <input
                    ...
                    name="remember"
                    type="checkbox"
                    className="bg-gray-50 border-gray-300 focus:ring-3 focus:ring-gray-200 h-4 w-4 rounded"
                  />
                </div>
                ...
                <Link href="/recover" passHref>
                  <a className="text-sm text-gray-700 hover:underline ml-auto">
                    recuperar password?
                  </a>
                </Link>
              </div>
              ...
              <button
                type="submit"
                className="text-white bg-gray-700 hover:bg-gray-500 focus:ring-4 focus:bg-amber-500font-medium rounded-lg text-base px-5 py-3 w-full sm:w-auto text-center"
              >
                Entrar em sua conta
              </button>
              ...
              <div className="text-sm font-medium text-gray-500">
                Não tem cadastro?{" "}
                <a className="text-gray-700 hover:underline">Criar uma conta</a>
              </div>
            </form>
          </div>
        </div>
